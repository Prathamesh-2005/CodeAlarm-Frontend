...
import { Eye, EyeOff, AlarmClock, Trophy, CalendarClock, Bell, Sparkles, ArrowRight, Heart, UserPlus, CheckCircle2 } from 'lucide-react';
      ...
      <header className={`border-b ${isDark ? 'bg-gray-900/80 border-gray-800' : 'bg-white border-gray-200'}`}>
        <div className="max-w-7xl mx-auto px-6 py-3.5 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <Link
              to="/register"
              className="px-4 py-2 text-sm font-semibold text-white rounded-md bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 transition-all"
            >
              Sign Up
            </Link>
            <Link
        ...
        <div className="flex-1 flex items-center justify-center p-6 lg:p-10">
          <div className="w-full max-w-sm">
            ...
            <div className="mb-5 text-center">
              <div className="inline-flex items-center justify-center w-11 h-11 rounded-full bg-gradient-to-br from-purple-600 to-blue-600 mb-3">
                <UserPlus className="h-5 w-5 text-white" />
              </div>
              <h2 className={`text-3xl font-bold mb-2 ${isDark ? 'text-white' : 'text-gray-900'}`}>Create an account</h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-3">
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className={`${inputBase} pr-9 ${errors.password ? 'border-red-500' : ''}`}
                    placeholder="••••••••"
                  />
                  <button
                    type="button"
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className={`${inputBase} pr-9 ${errors.confirmPassword ? 'border-red-500' : ''}`}
                    placeholder="••••••••"
                  />
                  <button
                    type="button"
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full py-2 px-4 text-sm font-medium text-white rounded-md bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed transition-all mt-1"
              >
                {loading ? (
            ...
            <p className={`mt-4 text-center text-base ${isDark ? 'text-gray-400' : 'text-gray-500'}`}>
