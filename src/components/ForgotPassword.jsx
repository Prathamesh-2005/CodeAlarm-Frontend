...
import { AlarmClock, Mail, Trophy, CalendarClock, Bell, Sparkles, ArrowRight, Heart } from 'lucide-react';
...
const ForgotPassword = () => {
  ...
  useEffect(() => {
    let timer;
    if (loading) {
      // Show warning after 5 seconds of loading (email sending can be slow)
      timer = setTimeout(() => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setMessage(response.message || 'Password reset link sent to your email. Please check your inbox and spam folder.');
    } catch (err) {
      let errorMessage = 'Failed to send reset link. Please try again.';
      
      if (err.message?.includes('timeout')) {
        errorMessage = 'Request timed out. The server may be waking up. Please wait a minute and try again.';
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', marginBottom: 28 }}>
              <div style={{
                ...
                <AlarmClock style={{ width: 32, height: 32, color: '#fff' }} />
              </div>
            ...
            <form style={{ display: 'flex', flexDirection: 'column', gap: 18 }} onSubmit={handleSubmit}>
              ...
              <div style={{
                ...
                <span style={{ lineHeight: 1.5 }}>
                  <strong>Note:</strong> Backend is on free tier. Email sending may take 30-90 seconds. Please be patient.
                </span>
              </div>
              ...
              {showSlowWarning && loading && (
                <div style={{
                  ...
                  <span style={{ lineHeight: 1.5 }}>
                    Server is processing... This may take up to 90 seconds for email delivery. Please wait.
                  </span>
                </div>
              )}
              ...
              <div>
                ...
                <div style={{ position: 'relative' }}>
                  <div style={{
                    ...
                    <Mail style={{ width: 18, height: 18, color: textSec }} />
                  </div>
                  <input
                    id="email"
                    name="email"
